...
## Vision
Build a WebGL-first subtitle renderer that consumes Subforge `SubtitleDocument` and targets **full ASS spec rendering with 1:1 visual parity vs libass** on web and Bun, with a path to WebGPU.
