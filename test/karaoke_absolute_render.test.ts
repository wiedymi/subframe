...
Dialogue: 0,0:00:00.00,0:00:05.00,Default,,0,0,0,,{\\kt50\\k10}A{\\k10}B
`;

test("\\kt sets absolute karaoke time", async () => {
  ...
  expect(startsBySegment.get(0)).toBe(500);
  expect(startsBySegment.get(1)).toBe(600);
});
